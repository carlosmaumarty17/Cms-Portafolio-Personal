                ...
                <footer class="main-footer sticky footer-type-1">
                    <div class="footer-inner">
                        <div class="footer-text">
                            <strong><a href="https://www.canva.com/design/DAGDRdKPhbY/Ry9o7l5lMcD2k0ih19ngaA/view?utm_content=DAGDRdKPhbY&utm_campaign=designshare&utm_medium=link&utm_source=editor"><?php echo '© ING CARLOS ' . date("Y") ?></a></strong>.
                        </div>
                        <div class="go-up">
                            <a href="#" rel="go-top">

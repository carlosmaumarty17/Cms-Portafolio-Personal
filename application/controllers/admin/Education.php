...
class Education extends CIF_Controller {

    public $layout = 'full';
    public $module = 'education';
    public $model = 'Education_model';
    ...
    public function index() {
        ...
        $config['base_url'] = site_url('admin/education/index');
    ...
    public function manage($id = FALSE) {
        ...
        $this->form_validation->set_rules('school', 'lang:school', 'trim|required');
        $this->form_validation->set_rules('field', 'lang:field', 'trim|required');
        ...
        if ($this->form_validation->run() == FALSE)
            ...
            $this->{$this->model}->school = $this->input->post('school');
            $this->{$this->model}->field = $this->input->post('field');
